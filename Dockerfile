...
RUN wget http://packages.couchbase.com/releases/couchbase-sync-gateway/1.4.1/couchbase-sync-gateway-enterprise_1.4.1-3_x86_64.rpm && \
    rpm -i couchbase-sync-gateway-enterprise_1.4.1-3_x86_64.rpm && \
    rm couchbase-sync-gateway-enterprise_1.4.1-3_x86_64.rpm
